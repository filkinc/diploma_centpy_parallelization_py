...
\date{11 июня 2026 г.}
\titlegraphic{\includegraphics[width=3.25 cm]{Logo_Blue_No-BG.pdf}}
	...
	\begin{frame}{Анализ сходимости в двумерной постановке}
		...
		\begin{columns}[t]
			...
			\begin{column}{0.46\textwidth}
				...
				%				\vspace{0.5cm}
				\textbf{Тест:} перенос гладкого изоэнтропического вихря
	...
	\begin{frame}{Заключение и основные результаты}
		...
		\begin{block}{Выводы}
			\begin{enumerate}
				...
				\item В двумерных задачах решатель на GPU быстрее собственной CPU-реализации до $33\times$ (SD2) и $60\times$ (FD2), быстрее centpy в $90$--$100\times$, быстрее JAX-FLUIDS в $2.5$--$6\times$; достигнута сетка $1024\times1024$.
			\end{enumerate}
		\end{block}
...
\begin{frame}
	\begin{block}{Как работает JAX (JIT-компиляция)}
		\small
