...
%	\end{frame}
	...
	\begin{frame}{Сравнительный анализ аппаратного ускорения: одномерная постановка}
		...
		\begin{columns}[c]
			...
			\begin{column}{0.58\textwidth}
				...
				\begin{table}[h]
					\centering
					\caption{\smaller{Ускорение Разраб. GPU (1D, $J=16384$)}}
					\vspace{-0.3 cm}
	...
	\begin{frame}{Двумерная постановка задачи}
		...
		\vspace{-0.2 cm}
		Две зоны пониженной плотности при $\alpha = 0.1$ --- круговая (центр $(0.45, 0.65)$, радиус $0.08$) и прямоугольная ; Слева  --- ГУ Неймана, Справа --- ГУ непротекания.
